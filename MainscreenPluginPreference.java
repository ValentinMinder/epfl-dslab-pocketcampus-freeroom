...
public class MainscreenPluginPreference extends PluginPreference {
	...
	private PreferenceScreen createPreferenceHierarchy() {
		...
		for(PluginBase plugin : newsProviders) {
			...
			checkBoxPref.setKey(plugin.getPluginInfo().getId().toString());

			checkBoxPref.setTitle(plugin.getPluginInfo().getNameResource());

			boolean checked = PreferenceManager.getDefaultSharedPreferences(that).getBoolean(plugin.getPluginInfo().getId().toString(), true);
