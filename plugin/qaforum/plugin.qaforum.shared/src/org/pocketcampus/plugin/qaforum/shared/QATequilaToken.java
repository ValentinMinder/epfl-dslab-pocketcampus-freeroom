...
public class QATequilaToken implements org.apache.thrift.TBase<QATequilaToken, QATequilaToken._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("QATequilaToken");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QATequilaToken.class, metaDataMap);
  }

  public QATequilaToken() {
  }
   ...
   */
  public QATequilaToken(QATequilaToken other) {
  ...
  public QATequilaToken deepCopy() {
    return new QATequilaToken(this);
  }
  ...
  public QATequilaToken setITequilaKey(String iTequilaKey) {
    this.iTequilaKey = iTequilaKey;
    return this;
  }
  ...
  public QATequilaToken setLoginCookie(String loginCookie) {
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QATequilaToken)
      return this.equals((QATequilaToken)that);
    return false;
  }

  public boolean equals(QATequilaToken that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QATequilaToken other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QATequilaToken typedOther = (QATequilaToken)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("QATequilaToken(");
    boolean first = true;
