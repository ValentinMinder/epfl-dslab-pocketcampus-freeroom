...
public class MyQuestionsRequest extends Request<QAforumController, Iface, String, String> {

	@Override
	protected String runInBackground(Iface client, String param)
			throws Exception {
		return client.myQuestions(param);
	}
	...
	protected void onResult(QAforumController controller, String result) {
		if (result.equals("invalid")) {
			...
			try {
				controller.callactivityMyquestions(result);
