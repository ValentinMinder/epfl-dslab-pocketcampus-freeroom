...
public class CloudPrintMultiPageConfig implements org.apache.thrift.TBase<CloudPrintMultiPageConfig, CloudPrintMultiPageConfig._Fields>, java.io.Serializable, Cloneable, Comparable<CloudPrintMultiPageConfig> {
  ...
  static {
    schemes.put(StandardScheme.class, new CloudPrintMultiPageConfigStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CloudPrintMultiPageConfigTupleSchemeFactory());
  }
  ...
  public int hashCode() {
    ...
    list.add(present_nbPagesPerSheet);
    if (present_nbPagesPerSheet)
      list.add(nbPagesPerSheet.getValue());

    boolean present_layout = true && (isSetLayout());
    list.add(present_layout);
    if (present_layout)
      list.add(layout.getValue());
  ...
  public int compareTo(CloudPrintMultiPageConfig other) {
    ...
    lastComparison = Boolean.valueOf(isSetNbPagesPerSheet()).compareTo(other.isSetNbPagesPerSheet());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNbPagesPerSheet()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nbPagesPerSheet, other.nbPagesPerSheet);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetLayout()).compareTo(other.isSetLayout());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLayout()) {
  ...
  private static class CloudPrintMultiPageConfigStandardSchemeFactory implements SchemeFactory {
    public CloudPrintMultiPageConfigStandardScheme getScheme() {
      return new CloudPrintMultiPageConfigStandardScheme();
    }
  }

  private static class CloudPrintMultiPageConfigStandardScheme extends StandardScheme<CloudPrintMultiPageConfig> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CloudPrintMultiPageConfig struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // NB_PAGES_PER_SHEET
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.nbPagesPerSheet = org.pocketcampus.plugin.cloudprint.shared.CloudPrintNbPagesPerSheet.findByValue(iprot.readI32());
              struct.setNbPagesPerSheetIsSet(true);
            } else { 
          ...
          case 2: // LAYOUT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.layout = org.pocketcampus.plugin.cloudprint.shared.CloudPrintMultiPageLayout.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CloudPrintMultiPageConfig struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      if (struct.nbPagesPerSheet != null) {
        oprot.writeFieldBegin(NB_PAGES_PER_SHEET_FIELD_DESC);
        oprot.writeI32(struct.nbPagesPerSheet.getValue());
        oprot.writeFieldEnd();
      }
  ...
  private static class CloudPrintMultiPageConfigTupleSchemeFactory implements SchemeFactory {
    public CloudPrintMultiPageConfigTupleScheme getScheme() {
      return new CloudPrintMultiPageConfigTupleScheme();
    }
  }

  private static class CloudPrintMultiPageConfigTupleScheme extends TupleScheme<CloudPrintMultiPageConfig> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CloudPrintMultiPageConfig struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CloudPrintMultiPageConfig struct) throws org.apache.thrift.TException {
