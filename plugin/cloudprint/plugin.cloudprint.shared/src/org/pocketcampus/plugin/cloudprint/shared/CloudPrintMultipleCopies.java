...
public class CloudPrintMultipleCopies implements org.apache.thrift.TBase<CloudPrintMultipleCopies, CloudPrintMultipleCopies._Fields>, java.io.Serializable, Cloneable, Comparable<CloudPrintMultipleCopies> {
  ...
  static {
    schemes.put(StandardScheme.class, new CloudPrintMultipleCopiesStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CloudPrintMultipleCopiesTupleSchemeFactory());
  }
  ...
  public void unsetNumberOfCopies() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __NUMBEROFCOPIES_ISSET_ID);
  }
  ...
  public boolean isSetNumberOfCopies() {
    return EncodingUtils.testBit(__isset_bitfield, __NUMBEROFCOPIES_ISSET_ID);
  }

  public void setNumberOfCopiesIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __NUMBEROFCOPIES_ISSET_ID, value);
  }
  ...
  public void unsetCollate() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __COLLATE_ISSET_ID);
  }

  /** Returns true if field collate is set (has been assigned a value) and false otherwise */
  public boolean isSetCollate() {
    return EncodingUtils.testBit(__isset_bitfield, __COLLATE_ISSET_ID);
  }

  public void setCollateIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __COLLATE_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    list.add(present_numberOfCopies);
    if (present_numberOfCopies)
      list.add(numberOfCopies);

    boolean present_collate = true;
    list.add(present_collate);
    if (present_collate)
      list.add(collate);
  ...
  public int compareTo(CloudPrintMultipleCopies other) {
    ...
    lastComparison = Boolean.valueOf(isSetNumberOfCopies()).compareTo(other.isSetNumberOfCopies());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumberOfCopies()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numberOfCopies, other.numberOfCopies);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetCollate()).compareTo(other.isSetCollate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCollate()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.collate, other.collate);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class CloudPrintMultipleCopiesStandardSchemeFactory implements SchemeFactory {
    public CloudPrintMultipleCopiesStandardScheme getScheme() {
      return new CloudPrintMultipleCopiesStandardScheme();
    }
  }

  private static class CloudPrintMultipleCopiesStandardScheme extends StandardScheme<CloudPrintMultipleCopies> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CloudPrintMultipleCopies struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          case 1: // NUMBER_OF_COPIES
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.numberOfCopies = iprot.readI32();
              struct.setNumberOfCopiesIsSet(true);
            } else { 
          ...
          case 2: // COLLATE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.collate = iprot.readBool();
              struct.setCollateIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CloudPrintMultipleCopies struct) throws org.apache.thrift.TException {
      struct.validate();

      oprot.writeStructBegin(STRUCT_DESC);
      oprot.writeFieldBegin(NUMBER_OF_COPIES_FIELD_DESC);
      oprot.writeI32(struct.numberOfCopies);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(COLLATE_FIELD_DESC);
      oprot.writeBool(struct.collate);
      oprot.writeFieldEnd();
  ...
  private static class CloudPrintMultipleCopiesTupleSchemeFactory implements SchemeFactory {
    public CloudPrintMultipleCopiesTupleScheme getScheme() {
      return new CloudPrintMultipleCopiesTupleScheme();
    }
  }

  private static class CloudPrintMultipleCopiesTupleScheme extends TupleScheme<CloudPrintMultipleCopies> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CloudPrintMultipleCopies struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CloudPrintMultipleCopies struct) throws org.apache.thrift.TException {
