...
public class MealTagger {
	...
	public MealTagger() {
		...
		Pattern fishPatterns = Pattern
				.compile(
						".*(poisson|carrelet|lotte|dorade|chevalier|cabillaud|saumon|pangasius|lieu|bar|mulet|truite|st.?Pierre|colin|perche|rougaille|calamars|hoki|sandre|carpe|raie).*",
						Pattern.CASE_INSENSITIVE | Pattern.MULTILINE);
