...
public class Rating implements org.apache.thrift.TBase<Rating, Rating._Fields>, java.io.Serializable, Cloneable, Comparable<Rating> {
  ...
  public void unsetNumberOfVotes() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __NUMBEROFVOTES_ISSET_ID);
  }
  ...
  public boolean isSetNumberOfVotes() {
    return EncodingUtils.testBit(__isset_bitfield, __NUMBEROFVOTES_ISSET_ID);
  }

  public void setNumberOfVotesIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __NUMBEROFVOTES_ISSET_ID, value);
  }
  ...
  public void unsetSumOfRatings() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SUMOFRATINGS_ISSET_ID);
  }

  /** Returns true if field sumOfRatings is set (has been assigned a value) and false otherwise */
  public boolean isSetSumOfRatings() {
    return EncodingUtils.testBit(__isset_bitfield, __SUMOFRATINGS_ISSET_ID);
  }

  public void setSumOfRatingsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SUMOFRATINGS_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    list.add(present_numberOfVotes);
    if (present_numberOfVotes)
      list.add(numberOfVotes);

    boolean present_sumOfRatings = true;
    list.add(present_sumOfRatings);
    if (present_sumOfRatings)
      list.add(sumOfRatings);
  ...
  public int compareTo(Rating other) {
    ...
    lastComparison = Boolean.valueOf(isSetNumberOfVotes()).compareTo(other.isSetNumberOfVotes());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNumberOfVotes()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.numberOfVotes, other.numberOfVotes);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetSumOfRatings()).compareTo(other.isSetSumOfRatings());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSumOfRatings()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sumOfRatings, other.sumOfRatings);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class RatingStandardScheme extends StandardScheme<Rating> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // NUMBER_OF_VOTES
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.numberOfVotes = iprot.readI32();
              struct.setNumberOfVotesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 3: // SUM_OF_RATINGS
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.sumOfRatings = iprot.readDouble();
              struct.setSumOfRatingsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Rating struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.numberOfVotes);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(SUM_OF_RATINGS_FIELD_DESC);
      oprot.writeDouble(struct.sumOfRatings);
      oprot.writeFieldEnd();
