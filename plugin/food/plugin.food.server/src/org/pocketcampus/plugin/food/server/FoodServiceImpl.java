...
public class FoodServiceImpl implements FoodService.Iface{
	 ...
	 * 
	 * @param meal The Meal for which we want the Rating
	...
	/**
	 * Get all the Ratings for today's meals
	 * Not working correctly, I think when the menus are up to date (meaning it's still today)
	 * it doesn't get the Ratings again 'cause of the updateMenus method...
	 * 
	 * @return mCampusMealRatings the map of all ratings associated with the corresponding meal
	 */
	@Override
	...
	/**
	 * Sets the Rating for a particular Meal
	 * Missing deviceID and mealHashcode because we don't get parameters from the Request...
	 * TODO : find another way to pass the info (lazy for now...)
	 * 
...
//		}
	...
	private void importSandwiches() {
		/* Cafeteria INM */
		Restaurant cafeteriaINM = new Restaurant(("Cafeteria INM").hashCode(), "Cafeteria INM");
		mCampusSandwiches.add(new Sandwich((cafeteriaINM.getName() + "Poulet au Curry").hashCode(), 
				cafeteriaINM, "Poulet au Curry"));
		mCampusSandwiches.add(new Sandwich((cafeteriaINM.getName() + "Thon").hashCode(), cafeteriaINM, "Thon"));
		mCampusSandwiches.add(new Sandwich((cafeteriaINM.getName() + "Jambon").hashCode(), cafeteriaINM, "Jambon"));
		mCampusSandwiches.add(new Sandwich((cafeteriaINM.getName() + "Fromage").hashCode(), cafeteriaINM, "Fromage"));
		mCampusSandwiches.add(new Sandwich((cafeteriaINM.getName() + "Tomate Mozzarella").hashCode(), 
				cafeteriaINM, "Tomate Mozzarella"));
		mCampusSandwiches.add(new Sandwich((cafeteriaINM.getName() + "Jambon Cru").hashCode(), 
				cafeteriaINM, "Jambon Cru"));
		mCampusSandwiches.add(new Sandwich((cafeteriaINM.getName() + "Salami").hashCode(), cafeteriaINM, "Salami"));
		mCampusSandwiches.add(new Sandwich((cafeteriaINM.getName() + "Autres").hashCode(), cafeteriaINM, "Autres"));
		...
		Restaurant leGiacometti = new Restaurant(("Le Giacometti").hashCode(), "Le Giacometti");
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Jambon").hashCode(), 
				leGiacometti, "Jambon"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Salami").hashCode(), 
				leGiacometti, "Salami"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Jambon de dinde").hashCode(), 
				leGiacometti, "Jambon de dinde"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Gruyère").hashCode(), 
				leGiacometti, "Gruyière"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Viande Séchée").hashCode(), 
				leGiacometti, "Viande Séchée"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Jambon Cru").hashCode(), 
				leGiacometti, "Jambon Cru"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Roast-Beef").hashCode(), 
				leGiacometti, "Roast-Beef"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Poulet Jijommaise").hashCode(), 
				leGiacometti, "Poulet Jijommaise"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Crevettes").hashCode(), 
				leGiacometti, "Crevettes"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Saumon Fumé").hashCode(), 
				leGiacometti, "Saumon Fumé"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Poulet au Curry").hashCode(), 
				leGiacometti, "Poulet au Curry"));
		mCampusSandwiches.add(new Sandwich((leGiacometti.getName() + "Autres").hashCode(), 
				leGiacometti, "Autres"));

		/* L'Esplanade */
		Restaurant lEsplanade = new Restaurant(("L'Esplanade").hashCode(), "L'Esplanade");
		mCampusSandwiches.add(new Sandwich((lEsplanade.getName() + "Thon").hashCode(), 
				lEsplanade, "Thon"));
		mCampusSandwiches.add(new Sandwich((lEsplanade.getName() + "Poulet au Curry").hashCode(), 
				lEsplanade, "Poulet au Curry"));
		mCampusSandwiches.add(new Sandwich((lEsplanade.getName() + "Aubergine").hashCode(), 
				lEsplanade, "Aubergine"));
		mCampusSandwiches.add(new Sandwich((lEsplanade.getName() + "Roast-Beef").hashCode(), 
				lEsplanade, "Roast-Beef"));
		mCampusSandwiches.add(new Sandwich((lEsplanade.getName() + "Jambon Cru").hashCode(), 
				lEsplanade, "Jambon Cru"));
		mCampusSandwiches.add(new Sandwich((lEsplanade.getName() + "Viande Séchée").hashCode(), 
				lEsplanade, "Viande Séchée"));
		mCampusSandwiches.add(new Sandwich((lEsplanade.getName() + "Saumon Fumé").hashCode(), 
				lEsplanade, "Saumon Fumé"));
		mCampusSandwiches.add(new Sandwich((lEsplanade.getName() + "Autres").hashCode(), 
				lEsplanade, "Autres"));
		...
		/* Atlantide */
		Restaurant lAtlantide = new Restaurant(("L'Atlantide").hashCode(), "L'Atlantide");
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Sandwich long").hashCode(), 
				lAtlantide, "Sandwich long"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Sandwich au pavot").hashCode(), 
				lAtlantide, "Sandwich au pavot"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Sandwich intégral").hashCode(), 
				lAtlantide, "Sandwich intégral"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Sandwich provençal").hashCode(), 
				lAtlantide, "Sandwich provençal"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Parisette").hashCode(), 
				lAtlantide, "Parisette"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Jambon").hashCode(), 
				lAtlantide, "Jambon"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Salami").hashCode(), 
				lAtlantide, "Salami"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() +"Dinde").hashCode(), 
				lAtlantide, "Dinde"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Thon").hashCode(), 
				lAtlantide, "Thon"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Mozzarella").hashCode(), 
				lAtlantide, "Mozzarella"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Saumon Fumé").hashCode(), 
				lAtlantide, "Saumon Fumé"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Viande Séchée").hashCode(), 
				lAtlantide, "Viande Séchée"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Jambon Cru").hashCode(), 
				lAtlantide, "Jambon Cru"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Roast-Beef").hashCode(), 
				lAtlantide, "Roast-Beef"));
		mCampusSandwiches.add(new Sandwich((lAtlantide.getName() + "Autres").hashCode(), 
				lAtlantide, "Autres"));

		/* Satellite */
		Restaurant satellite = new Restaurant(("Satellite").hashCode(), "Satellite");
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Thon").hashCode(), 
				satellite, "Thon"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Jambon Fromage").hashCode(), 
				satellite, "Jambon Fromage"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Roast-Beef").hashCode(), 
				satellite, "Roast-Beef"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Poulet au Curry").hashCode(), 
				satellite, "Poulet au Curry"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Jambon Cru").hashCode(), 
				satellite, "Jambon Cru"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Tomate Mozzarella").hashCode(), 
				satellite, "Tomate Mozzarella"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Salami").hashCode(), 
				satellite, "Salami"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Parmesan").hashCode(), 
				satellite, "Parmesan"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Aubergine grillée").hashCode(), 
				satellite, "Aubergine grillée"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Viande séchée").hashCode(), 
				satellite, "Viande séchée"));
		mCampusSandwiches.add(new Sandwich((satellite.getName() + "Autres").hashCode(), 
				satellite, "Autres"));

		/* Négoce */
		Restaurant negoce = new Restaurant(("Négoce").hashCode(), "Négoce");
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Dinde").hashCode(), 
				negoce, "Dinde"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Thon").hashCode(), 
				negoce, "Thon"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Gratiné Jambon").hashCode(), 
				negoce, "Gratiné Jambon"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Mozzarella Olives").hashCode(), 
				negoce, "Mozzarella Olives"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Poulet au Curry").hashCode(), 
				negoce, "Poulet au Curry"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Jambon Fromage").hashCode(), 
				negoce, "Jambon Fromage"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Jambon").hashCode(), 
				negoce, "Jambon"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Salami").hashCode(), 
				negoce, "Salami"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Roast-Beef").hashCode(), 
				negoce, "Roast-Beef"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Mozarrella").hashCode(), 
				negoce, "Mozzarella"));
		mCampusSandwiches.add(new Sandwich((negoce.getName() + "Autres").hashCode(), 
				negoce, "Autres"));
	...
	private Vector<Sandwich> defaultSandwichList(String name) {
		...
		defaultSandwichList.add(new Sandwich((name + "Thon").hashCode(), r, "Thon"));
		defaultSandwichList.add(new Sandwich((name + "Jambon").hashCode(), r, "Jambon"));
		defaultSandwichList.add(new Sandwich((name + "Fromage").hashCode(), r, "Fromage"));
		defaultSandwichList.add(new Sandwich((name + "Tomate Mozzarella").hashCode(), r, "Tomate Mozzarella"));
		defaultSandwichList.add(new Sandwich((name + "Jambon Cru").hashCode(), r, "Jambon Cru"));
		defaultSandwichList.add(new Sandwich((name + "Salami").hashCode(), r, "Salami"));
		defaultSandwichList.add(new Sandwich((name + "Autres").hashCode(), r, "Autres"));
