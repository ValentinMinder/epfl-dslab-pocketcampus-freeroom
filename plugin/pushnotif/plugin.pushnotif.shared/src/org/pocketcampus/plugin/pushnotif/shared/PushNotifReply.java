...
public class PushNotifReply implements org.apache.thrift.TBase<PushNotifReply, PushNotifReply._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PushNotifReply");

  private static final org.apache.thrift.protocol.TField I_STATUS_FIELD_DESC = new org.apache.thrift.protocol.TField("iStatus", org.apache.thrift.protocol.TType.I32, (short)1);

  public int iStatus; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    I_STATUS((short)1, "iStatus");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PushNotifReply.class, metaDataMap);
  }

  public PushNotifReply() {
  }
   ...
   */
  public PushNotifReply(PushNotifReply other) {
    __isset_bit_vector.clear();
    __isset_bit_vector.or(other.__isset_bit_vector);
    this.iStatus = other.iStatus;
  }

  public PushNotifReply deepCopy() {
    return new PushNotifReply(this);
  }
  ...
  public PushNotifReply setIStatus(int iStatus) {
    this.iStatus = iStatus;
    setIStatusIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PushNotifReply)
      return this.equals((PushNotifReply)that);
    return false;
  }

  public boolean equals(PushNotifReply that) {
    if (that == null)
      return false;
  ...
  public int compareTo(PushNotifReply other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    PushNotifReply typedOther = (PushNotifReply)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PushNotifReply(");
    boolean first = true;
