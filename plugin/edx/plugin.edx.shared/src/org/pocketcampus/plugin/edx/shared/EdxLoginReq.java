...
public class EdxLoginReq implements org.apache.thrift.TBase<EdxLoginReq, EdxLoginReq._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(EdxLoginReq other) {
    ...
    EdxLoginReq typedOther = (EdxLoginReq)other;
