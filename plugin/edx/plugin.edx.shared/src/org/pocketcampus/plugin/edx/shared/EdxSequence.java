...
public class EdxSequence implements org.apache.thrift.TBase<EdxSequence, EdxSequence._Fields>, java.io.Serializable, Cloneable {
  ...
  private Map<Integer,EdxItemVideo> videoItems; // required
  private Map<Integer,EdxItemHtml> htmlItems; // required
  private Map<Integer,EdxItemProblem> problemItems; // required
  ...
  public EdxSequence(EdxSequence other) {
    ...
    if (other.isSetItems()) {
      List<EdxItemType> __this__items = new ArrayList<EdxItemType>();
    ...
    if (other.isSetVideoItems()) {
      Map<Integer,EdxItemVideo> __this__videoItems = new HashMap<Integer,EdxItemVideo>();
    ...
    if (other.isSetHtmlItems()) {
      Map<Integer,EdxItemHtml> __this__htmlItems = new HashMap<Integer,EdxItemHtml>();
    ...
    if (other.isSetProblemItems()) {
      Map<Integer,EdxItemProblem> __this__problemItems = new HashMap<Integer,EdxItemProblem>();
  ...
  public int hashCode() {
    ...
    builder.append(present_verticalId);
    if (present_verticalId)
      builder.append(verticalId);
    ...
    builder.append(present_videoItems);
    if (present_videoItems)
      builder.append(videoItems);

    boolean present_htmlItems = true && (isSetHtmlItems());
    builder.append(present_htmlItems);
    if (present_htmlItems)
      builder.append(htmlItems);

    boolean present_problemItems = true && (isSetProblemItems());
    builder.append(present_problemItems);
    if (present_problemItems)
      builder.append(problemItems);
  ...
  public int compareTo(EdxSequence other) {
    ...
    EdxSequence typedOther = (EdxSequence)other;

    lastComparison = Boolean.valueOf(isSetVerticalId()).compareTo(typedOther.isSetVerticalId());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVerticalId()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.verticalId, typedOther.verticalId);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetVideoItems()).compareTo(typedOther.isSetVideoItems());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetVideoItems()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.videoItems, typedOther.videoItems);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetHtmlItems()).compareTo(typedOther.isSetHtmlItems());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHtmlItems()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.htmlItems, typedOther.htmlItems);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetProblemItems()).compareTo(typedOther.isSetProblemItems());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetProblemItems()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.problemItems, typedOther.problemItems);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
      ...
      switch (field.id) {
        case 1: // VERTICAL_ID
          if (field.type == org.apache.thrift.protocol.TType.STRING) {
            this.verticalId = iprot.readString();
          } else { 
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.items = new ArrayList<EdxItemType>(_list4.size);
              for (int _i5 = 0; _i5 < _list4.size; ++_i5)
              {
                EdxItemType _elem6; // required
                _elem6 = EdxItemType.findByValue(iprot.readI32());
          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.videoItems = new HashMap<Integer,EdxItemVideo>(2*_map7.size);
              for (int _i8 = 0; _i8 < _map7.size; ++_i8)
              {
                int _key9; // required
                EdxItemVideo _val10; // required
                _key9 = iprot.readI32();
                _val10 = new EdxItemVideo();
                _val10.read(iprot);
                this.videoItems.put(_key9, _val10);
              }
              iprot.readMapEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.htmlItems = new HashMap<Integer,EdxItemHtml>(2*_map11.size);
              for (int _i12 = 0; _i12 < _map11.size; ++_i12)
              {
                int _key13; // required
                EdxItemHtml _val14; // required
                _key13 = iprot.readI32();
                _val14 = new EdxItemHtml();
                _val14.read(iprot);
                this.htmlItems.put(_key13, _val14);
              }
              iprot.readMapEnd();
            }
          } else { 
          ...
          if (field.type == org.apache.thrift.protocol.TType.MAP) {
            {
              ...
              this.problemItems = new HashMap<Integer,EdxItemProblem>(2*_map15.size);
              for (int _i16 = 0; _i16 < _map15.size; ++_i16)
              {
                int _key17; // required
                EdxItemProblem _val18; // required
                _key17 = iprot.readI32();
                _val18 = new EdxItemProblem();
                _val18.read(iprot);
                this.problemItems.put(_key17, _val18);
              }
              iprot.readMapEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.verticalId != null) {
      ...
      oprot.writeString(this.verticalId);
      oprot.writeFieldEnd();
    }
    if (this.items != null) {
      oprot.writeFieldBegin(ITEMS_FIELD_DESC);
      {
        oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, this.items.size()));
        for (EdxItemType _iter19 : this.items)
        {
    ...
    if (this.videoItems != null) {
      if (isSetVideoItems()) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, this.videoItems.size()));
          for (Map.Entry<Integer, EdxItemVideo> _iter20 : this.videoItems.entrySet())
          {
    ...
    if (this.htmlItems != null) {
      if (isSetHtmlItems()) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, this.htmlItems.size()));
          for (Map.Entry<Integer, EdxItemHtml> _iter21 : this.htmlItems.entrySet())
          {
    ...
    if (this.problemItems != null) {
      if (isSetProblemItems()) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, this.problemItems.size()));
          for (Map.Entry<Integer, EdxItemProblem> _iter22 : this.problemItems.entrySet())
          {
