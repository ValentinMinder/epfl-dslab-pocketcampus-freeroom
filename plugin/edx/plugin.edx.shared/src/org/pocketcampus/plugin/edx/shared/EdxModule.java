...
public class EdxModule implements org.apache.thrift.TBase<EdxModule, EdxModule._Fields>, java.io.Serializable, Cloneable {
  ...
  public int hashCode() {
    ...
    builder.append(present_moduleTitle);
  ...
  public int compareTo(EdxModule other) {
    ...
    EdxModule typedOther = (EdxModule)other;
    ...
    lastComparison = Boolean.valueOf(isSetModuleTitle()).compareTo(typedOther.isSetModuleTitle());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetModuleTitle()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.moduleTitle, typedOther.moduleTitle);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
    ...
    while (true)
    {
      ...
      switch (field.id) {
        ...
        case 2: // MODULE_TITLE
          if (field.type == org.apache.thrift.protocol.TType.STRING) {
            this.moduleTitle = iprot.readString();
          } else { 
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
          }
          break;
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.moduleTitle != null) {
      ...
      oprot.writeString(this.moduleTitle);
      oprot.writeFieldEnd();
    }
