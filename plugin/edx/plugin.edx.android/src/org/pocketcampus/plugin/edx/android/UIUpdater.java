...
/**
 * A class used to perform periodical updates, specified inside a runnable
 * object. An update interval may be specified (otherwise, the class will
 * perform the update every half a second).
 * 
...
public class UIUpdater {
	...
	/**
	 * The same as the default constructor, but specifying the intended update
	 * interval.
	 * 
	 * @param uiUpdater
	 *            A runnable containing the update routine.
