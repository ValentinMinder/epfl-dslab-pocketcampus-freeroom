...
public class MoodleResource2 implements org.apache.thrift.TBase<MoodleResource2, MoodleResource2._Fields>, java.io.Serializable, Cloneable {
  ...
  private MoodleFile2 file; // required
  private MoodleFolder2 folder; // required
  private MoodleUrl2 url; // required
  ...
  public int compareTo(MoodleResource2 other) {
    ...
    MoodleResource2 typedOther = (MoodleResource2)other;
      ...
      switch (field.id) {
        case 1: // FILE
          if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
            this.file = new MoodleFile2();
            this.file.read(iprot);
          } else { 
        ...
        case 2: // FOLDER
          if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
            this.folder = new MoodleFolder2();
            this.folder.read(iprot);
          } else { 
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
          }
          break;
