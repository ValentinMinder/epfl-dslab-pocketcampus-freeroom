...
public class MoodleCoursesResponse2 implements org.apache.thrift.TBase<MoodleCoursesResponse2, MoodleCoursesResponse2._Fields>, java.io.Serializable, Cloneable, Comparable<MoodleCoursesResponse2> {
  ...
  static {
    schemes.put(StandardScheme.class, new MoodleCoursesResponse2StandardSchemeFactory());
    schemes.put(TupleScheme.class, new MoodleCoursesResponse2TupleSchemeFactory());
  }
  ...
  public MoodleCoursesResponse2(MoodleCoursesResponse2 other) {
    ...
    if (other.isSetCourses()) {
      List<MoodleCourse2> __this__courses = new ArrayList<MoodleCourse2>(other.courses.size());
  ...
  public int compareTo(MoodleCoursesResponse2 other) {
    ...
    lastComparison = Boolean.valueOf(isSetCourses()).compareTo(other.isSetCourses());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCourses()) {
  ...
  private static class MoodleCoursesResponse2StandardSchemeFactory implements SchemeFactory {
    public MoodleCoursesResponse2StandardScheme getScheme() {
      return new MoodleCoursesResponse2StandardScheme();
    }
  }

  private static class MoodleCoursesResponse2StandardScheme extends StandardScheme<MoodleCoursesResponse2> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MoodleCoursesResponse2 struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.courses = new ArrayList<MoodleCourse2>(_list40.size);
                MoodleCourse2 _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new MoodleCourse2();
                  _elem41.read(iprot);
                  struct.courses.add(_elem41);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MoodleCoursesResponse2 struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.courses != null) {
        oprot.writeFieldBegin(COURSES_FIELD_DESC);
        {
          ...
          for (MoodleCourse2 _iter43 : struct.courses)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class MoodleCoursesResponse2TupleSchemeFactory implements SchemeFactory {
    public MoodleCoursesResponse2TupleScheme getScheme() {
      return new MoodleCoursesResponse2TupleScheme();
    }
  }

  private static class MoodleCoursesResponse2TupleScheme extends TupleScheme<MoodleCoursesResponse2> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MoodleCoursesResponse2 struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      oprot.writeI32(struct.statusCode.getValue());
      {
        oprot.writeI32(struct.courses.size());
        for (MoodleCourse2 _iter44 : struct.courses)
        {
          _iter44.write(oprot);
        }
      }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MoodleCoursesResponse2 struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      struct.statusCode = org.pocketcampus.plugin.moodle.shared.MoodleStatusCode2.findByValue(iprot.readI32());
      struct.setStatusCodeIsSet(true);
      {
        org.apache.thrift.protocol.TList _list45 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.courses = new ArrayList<MoodleCourse2>(_list45.size);
        MoodleCourse2 _elem46;
        for (int _i47 = 0; _i47 < _list45.size; ++_i47)
        {
          _elem46 = new MoodleCourse2();
          _elem46.read(iprot);
          struct.courses.add(_elem46);
        }
      }
      struct.setCoursesIsSet(true);
    }
