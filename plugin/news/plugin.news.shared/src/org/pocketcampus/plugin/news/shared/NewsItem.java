...
public class NewsItem implements
		org.apache.thrift.TBase<NewsItem, NewsItem._Fields>,
	...
	private static final org.apache.thrift.protocol.TField DESCRIPTION_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"description", org.apache.thrift.protocol.TType.STRING, (short) 3);
	private static final org.apache.thrift.protocol.TField LINK_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"link", org.apache.thrift.protocol.TType.STRING, (short) 4);
	private static final org.apache.thrift.protocol.TField PUB_DATE_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"pubDate", org.apache.thrift.protocol.TType.STRING, (short) 5);
	private static final org.apache.thrift.protocol.TField PUB_DATE_DATE_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"pubDateDate", org.apache.thrift.protocol.TType.I64, (short) 6);
	private static final org.apache.thrift.protocol.TField IMAGE_URL_FIELD_DESC = new org.apache.thrift.protocol.TField(
			"imageUrl", org.apache.thrift.protocol.TType.STRING, (short) 7);
	...
	public enum _Fields implements org.apache.thrift.TFieldIdEnum {
		ID((short) 1, "id"), TITLE((short) 2, "title"), DESCRIPTION((short) 3,
				"description"), LINK((short) 4, "link"), PUB_DATE((short) 5,
				"pubDate"), PUB_DATE_DATE((short) 6, "pubDateDate"), IMAGE_URL(
				(short) 7, "imageUrl");
	...
	static {
		...
		tmpMap.put(_Fields.ID, new org.apache.thrift.meta_data.FieldMetaData(
				...
				new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.I64, "Id")));
		...
		tmpMap.put(_Fields.DESCRIPTION,
				new org.apache.thrift.meta_data.FieldMetaData("description",
						...
						new org.apache.thrift.meta_data.FieldValueMetaData(
								org.apache.thrift.protocol.TType.STRING)));
		tmpMap.put(_Fields.LINK, new org.apache.thrift.meta_data.FieldMetaData(
				"link", org.apache.thrift.TFieldRequirementType.REQUIRED,
				new org.apache.thrift.meta_data.FieldValueMetaData(
						org.apache.thrift.protocol.TType.STRING)));
		tmpMap.put(_Fields.PUB_DATE,
				new org.apache.thrift.meta_data.FieldMetaData("pubDate",
						org.apache.thrift.TFieldRequirementType.REQUIRED,
						new org.apache.thrift.meta_data.FieldValueMetaData(
								org.apache.thrift.protocol.TType.STRING)));
		tmpMap.put(_Fields.PUB_DATE_DATE,
				new org.apache.thrift.meta_data.FieldMetaData("pubDateDate",
						org.apache.thrift.TFieldRequirementType.REQUIRED,
						new org.apache.thrift.meta_data.FieldValueMetaData(
								org.apache.thrift.protocol.TType.I64,
								"timestamp")));
		tmpMap.put(_Fields.IMAGE_URL,
				new org.apache.thrift.meta_data.FieldMetaData("imageUrl",
						org.apache.thrift.TFieldRequirementType.OPTIONAL,
						new org.apache.thrift.meta_data.FieldValueMetaData(
								org.apache.thrift.protocol.TType.STRING)));
		metaDataMap = Collections.unmodifiableMap(tmpMap);
		org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
				NewsItem.class, metaDataMap);
	}

	public NewsItem() {
	}

	public NewsItem(long id, String title, String description, String link,
			String pubDate, long pubDateDate) {
		this();
		this.id = id;
		setIdIsSet(true);
		this.title = title;
	...
	/**
	 * Returns true if field link is set (has been assigned a value) and false
	 * otherwise
	 */
	...
	/**
	 * Returns true if field pubDate is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	/**
	 * Returns true if field pubDateDate is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	/**
	 * Returns true if field imageUrl is set (has been assigned a value) and
	 * false otherwise
	 */
	...
	public int compareTo(NewsItem other) {
		...
		lastComparison = Boolean.valueOf(isSetLink()).compareTo(
				typedOther.isSetLink());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetLink()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.link,
					typedOther.link);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPubDate()).compareTo(
				typedOther.isSetPubDate());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPubDate()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.pubDate, typedOther.pubDate);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetPubDateDate()).compareTo(
				typedOther.isSetPubDateDate());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetPubDateDate()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.pubDateDate, typedOther.pubDateDate);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
		lastComparison = Boolean.valueOf(isSetImageUrl()).compareTo(
				typedOther.isSetImageUrl());
		if (lastComparison != 0) {
			return lastComparison;
		}
		if (isSetImageUrl()) {
			lastComparison = org.apache.thrift.TBaseHelper.compareTo(
					this.imageUrl, typedOther.imageUrl);
			if (lastComparison != 0) {
				return lastComparison;
			}
		}
	...
	public void read(org.apache.thrift.protocol.TProtocol iprot)
		...
		if (!isSetPubDateDate()) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'pubDateDate' was not found in serialized data! Struct: "
							+ toString());
		}
		validate();
	}
	...
	public void validate() throws org.apache.thrift.TException {
		...
		if (title == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'title' was not present! Struct: "
							+ toString());
		}
		if (description == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'description' was not present! Struct: "
							+ toString());
		}
		if (link == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'link' was not present! Struct: "
							+ toString());
		}
		if (pubDate == null) {
			throw new org.apache.thrift.protocol.TProtocolException(
					"Required field 'pubDate' was not present! Struct: "
							+ toString());
		}
		// alas, we cannot check 'pubDateDate' because it's a primitive and you
