...
public class QueryConnectionResult implements org.apache.thrift.TBase<QueryConnectionResult, QueryConnectionResult._Fields>, java.io.Serializable, Cloneable {
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(QueryConnectionResult.class, metaDataMap);
  }

  public QueryConnectionResult() {
  }

  public QueryConnectionResult(
    List<TransportStation> ambiguousFrom,
    List<TransportStation> ambiguousVia,
    List<TransportStation> ambiguousTo,
    String queryUri,
   ...
   */
  public QueryConnectionResult(QueryConnectionResult other) {
  ...
  public QueryConnectionResult deepCopy() {
    return new QueryConnectionResult(this);
  }
  ...
  public QueryConnectionResult setAmbiguousFrom(List<TransportStation> ambiguousFrom) {
    this.ambiguousFrom = ambiguousFrom;
    return this;
  }
  ...
  public QueryConnectionResult setAmbiguousVia(List<TransportStation> ambiguousVia) {
    this.ambiguousVia = ambiguousVia;
    return this;
  }
  ...
  public QueryConnectionResult setAmbiguousTo(List<TransportStation> ambiguousTo) {
    this.ambiguousTo = ambiguousTo;
    return this;
  }
  ...
  public QueryConnectionResult setQueryUri(String queryUri) {
    this.queryUri = queryUri;
    return this;
  }
  ...
  public QueryConnectionResult setFrom(TransportStation from) {
    this.from = from;
    return this;
  }
  ...
  public QueryConnectionResult setVia(TransportStation via) {
    this.via = via;
    return this;
  }
  ...
  public QueryConnectionResult setTo(TransportStation to) {
    this.to = to;
    return this;
  }
  ...
  public QueryConnectionResult setContext(String context) {
    this.context = context;
    return this;
  }
  ...
  public QueryConnectionResult setConnections(List<TransportTrip> connections) {
    this.connections = connections;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof QueryConnectionResult)
      return this.equals((QueryConnectionResult)that);
    return false;
  }

  public boolean equals(QueryConnectionResult that) {
    if (that == null)
      return false;
  ...
  public int compareTo(QueryConnectionResult other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    QueryConnectionResult typedOther = (QueryConnectionResult)other;
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.ambiguousFrom = new ArrayList<TransportStation>(_list28.size);
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.ambiguousVia = new ArrayList<TransportStation>(_list31.size);
              for (int _i32 = 0; _i32 < _list31.size; ++_i32)
              {
                TransportStation _elem33; // required
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.ambiguousTo = new ArrayList<TransportStation>(_list34.size);
              for (int _i35 = 0; _i35 < _list34.size; ++_i35)
              {
                TransportStation _elem36; // required
                _elem36 = new TransportStation();
                _elem36.read(iprot);
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.connections = new ArrayList<TransportTrip>(_list37.size);
              for (int _i38 = 0; _i38 < _list37.size; ++_i38)
              {
                TransportTrip _elem39; // required
                _elem39 = new TransportTrip();
                _elem39.read(iprot);
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.ambiguousFrom != null) {
      oprot.writeFieldBegin(AMBIGUOUS_FROM_FIELD_DESC);
      {
        ...
        for (TransportStation _iter40 : this.ambiguousFrom)
        {
          _iter40.write(oprot);
        }
        oprot.writeListEnd();
    ...
    if (this.ambiguousVia != null) {
      oprot.writeFieldBegin(AMBIGUOUS_VIA_FIELD_DESC);
      {
        ...
        for (TransportStation _iter41 : this.ambiguousVia)
        {
          _iter41.write(oprot);
        }
        oprot.writeListEnd();
    ...
    if (this.ambiguousTo != null) {
      oprot.writeFieldBegin(AMBIGUOUS_TO_FIELD_DESC);
      {
        ...
        for (TransportStation _iter42 : this.ambiguousTo)
        {
          _iter42.write(oprot);
        }
        oprot.writeListEnd();
    ...
    if (this.connections != null) {
      oprot.writeFieldBegin(CONNECTIONS_FIELD_DESC);
      {
        ...
        for (TransportTrip _iter43 : this.connections)
        {
          _iter43.write(oprot);
        }
        oprot.writeListEnd();
