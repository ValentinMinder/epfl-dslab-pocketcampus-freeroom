...
public class TransportStationSearchResponse implements org.apache.thrift.TBase<TransportStationSearchResponse, TransportStationSearchResponse._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(TransportStationSearchResponse other) {
    ...
    TransportStationSearchResponse typedOther = (TransportStationSearchResponse)other;
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.stations = new ArrayList<TransportStation>(_list12.size);
              for (int _i13 = 0; _i13 < _list12.size; ++_i13)
              {
                TransportStation _elem14; // required
                _elem14 = new TransportStation();
                _elem14.read(iprot);
                this.stations.add(_elem14);
              }
              iprot.readListEnd();
            }
          } else { 
    ...
    if (this.stations != null) {
      if (isSetStations()) {
        oprot.writeFieldBegin(STATIONS_FIELD_DESC);
        {
          ...
          for (TransportStation _iter15 : this.stations)
          {
            _iter15.write(oprot);
          }
          oprot.writeListEnd();
