...
public class Part implements org.apache.thrift.TBase<Part, Part._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("Part");
  ...
  public Location departure; // required
  public Location arrival; // required
  public List<Point> path; // required
  public Line line; // required
  ...
  public Part setDeparture(Location departure) {
    this.departure = departure;
    return this;
  }
  ...
  public Part setArrival(Location arrival) {
    this.arrival = arrival;
    return this;
  }
  ...
  public Part setPath(List<Point> path) {
    this.path = path;
    return this;
  }
  ...
  public Part setDestination(Location destination) {
  ...
  public Part setDepartureTime(long departureTime) {
  ...
  public Part setDeparturePosition(String departurePosition) {
  ...
  public Part setArrivalTime(long arrivalTime) {
  ...
  public Part setArrivalPosition(String arrivalPosition) {
  ...
  public Part setIntermediateStops(List<Stop> intermediateStops) {
  ...
  public Part setFoot(boolean foot) {
    this.foot = foot;
    setFootIsSet(true);
    return this;
  }
