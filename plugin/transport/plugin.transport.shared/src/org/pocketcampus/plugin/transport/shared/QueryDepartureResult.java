          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.stationDepartures = new ArrayList<StationDepartures>(_list52.size);
              for (int _i53 = 0; _i53 < _list52.size; ++_i53)
              {
                StationDepartures _elem54; // required
                _elem54 = new StationDepartures();
                _elem54.read(iprot);
                this.stationDepartures.add(_elem54);
              }
              iprot.readListEnd();
            }
          } else { 
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.stationDepartures != null) {
      oprot.writeFieldBegin(STATION_DEPARTURES_FIELD_DESC);
      {
        ...
        for (StationDepartures _iter55 : this.stationDepartures)
        {
          _iter55.write(oprot);
        }
        oprot.writeListEnd();
