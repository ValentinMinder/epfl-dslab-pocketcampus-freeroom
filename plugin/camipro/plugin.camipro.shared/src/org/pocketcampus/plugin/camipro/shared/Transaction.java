...
public class Transaction implements org.apache.thrift.TBase<Transaction, Transaction._Fields>, java.io.Serializable, Cloneable {
  ...
  private static class TransactionStandardScheme extends StandardScheme<Transaction> {
        ...
        switch (schemeField.id) {
          case 1: // X_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.xType = iprot.readString();
              struct.setXTypeIsSet(true);
            } else { 
          ...
          case 2: // X_DESCRIPTION
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.xDescription = iprot.readString();
              struct.setXDescriptionIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 3: // X_DATE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.xDate = iprot.readString();
              struct.setXDateIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 4: // X_AMOUNT
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.xAmount = iprot.readDouble();
              struct.setXAmountIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Transaction struct) throws org.apache.thrift.TException {
      ...
      if (struct.xType != null) {
        oprot.writeFieldBegin(X_TYPE_FIELD_DESC);
        oprot.writeString(struct.xType);
        oprot.writeFieldEnd();
      }
      if (struct.xDescription != null) {
        oprot.writeFieldBegin(X_DESCRIPTION_FIELD_DESC);
        oprot.writeString(struct.xDescription);
        oprot.writeFieldEnd();
      }
      if (struct.xDate != null) {
        oprot.writeFieldBegin(X_DATE_FIELD_DESC);
        oprot.writeString(struct.xDate);
        oprot.writeFieldEnd();
      }
      oprot.writeFieldBegin(X_AMOUNT_FIELD_DESC);
      oprot.writeDouble(struct.xAmount);
      oprot.writeFieldEnd();
