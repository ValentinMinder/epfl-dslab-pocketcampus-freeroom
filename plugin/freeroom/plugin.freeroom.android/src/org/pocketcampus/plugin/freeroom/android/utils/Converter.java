...
public class Converter {
	...
	/**
	 * Define the period with more precision.
	 * for instance : Monday, 10h25-10h59 convertWith...sion(Calendar.Monday, 10, 15, 10, 59)
	 * @param day The day as defined in Calendar class.
	 * @param startHour The start of the period in hours
	 * @param startMin The precision in minutes for the start
	 * @param endHour The end of the period in hours
	 * @param endMin The precision in minutes for the end
	 * @return
	 */
