...
public class FRImWorkingReply implements org.apache.thrift.TBase<FRImWorkingReply, FRImWorkingReply._Fields>, java.io.Serializable, Cloneable, Comparable<FRImWorkingReply> {
  ...
  static {
    schemes.put(StandardScheme.class, new FRImWorkingReplyStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FRImWorkingReplyTupleSchemeFactory());
  }
  ...
  private static final _Fields optionals[] = {_Fields.STATUS_COMMENT};
  ...
  private static class FRImWorkingReplyStandardSchemeFactory implements SchemeFactory {
    public FRImWorkingReplyStandardScheme getScheme() {
      return new FRImWorkingReplyStandardScheme();
    }
  }

  private static class FRImWorkingReplyStandardScheme extends StandardScheme<FRImWorkingReply> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FRImWorkingReply struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FRImWorkingReply struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class FRImWorkingReplyTupleSchemeFactory implements SchemeFactory {
    public FRImWorkingReplyTupleScheme getScheme() {
      return new FRImWorkingReplyTupleScheme();
    }
  }

  private static class FRImWorkingReplyTupleScheme extends TupleScheme<FRImWorkingReply> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FRImWorkingReply struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, FRImWorkingReply struct) throws org.apache.thrift.TException {
