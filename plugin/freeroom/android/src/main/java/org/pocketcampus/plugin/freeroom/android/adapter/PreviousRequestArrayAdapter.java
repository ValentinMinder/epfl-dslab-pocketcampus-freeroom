...
import org.pocketcampus.plugin.freeroom.android.FreeRoomSearchActivity;
 ...
 */
public class PreviousRequestArrayAdapter<T> extends ArrayAdapter<FRRequestDetails> {

	private FreeRoomSearchActivity caller;

	public PreviousRequestArrayAdapter(FreeRoomSearchActivity caller, Context context, int row, int label,
			List<FRRequestDetails> items) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		// play click listener
		TextView requestTextView = (TextView) row.findViewById(R.id.freeroom_layout_prev_req_text);
		...
		// edit click listener
		ImageView editRequest = (ImageView) row.findViewById(R.id.freeroom_layout_prev_req_edit);
