...
public class TequilaSession implements org.apache.thrift.TBase<TequilaSession, TequilaSession._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TequilaSession");
  ...
  public String tequilaCookie; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TequilaSession.class, metaDataMap);
  }

  public TequilaSession() {
  }
   ...
   */
  public TequilaSession(TequilaSession other) {
    if (other.isSetTequilaCookie()) {
      this.tequilaCookie = other.tequilaCookie;
    }
  }

  public TequilaSession deepCopy() {
    return new TequilaSession(this);
  }
  ...
  public TequilaSession setTequilaCookie(String tequilaCookie) {
    this.tequilaCookie = tequilaCookie;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TequilaSession)
      return this.equals((TequilaSession)that);
    return false;
  }

  public boolean equals(TequilaSession that) {
    if (that == null)
      return false;
  ...
  public int compareTo(TequilaSession other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    TequilaSession typedOther = (TequilaSession)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TequilaSession(");
    boolean first = true;
