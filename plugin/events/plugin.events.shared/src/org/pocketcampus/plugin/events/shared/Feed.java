...
public class Feed implements org.apache.thrift.TBase<Feed, Feed._Fields>, java.io.Serializable, Cloneable {
  ...
  public List<EventsItem> items; // required
  ...
  public Feed(Feed other) {
    ...
    if (other.isSetItems()) {
      List<EventsItem> __this__items = new ArrayList<EventsItem>();
      for (EventsItem other_element : other.items) {
        __this__items.add(new EventsItem(other_element));
      }
  ...
  public java.util.Iterator<EventsItem> getItemsIterator() {
    return (this.items == null) ? null : this.items.iterator();
  }

  public void addToItems(EventsItem elem) {
    if (this.items == null) {
      this.items = new ArrayList<EventsItem>();
    }
    this.items.add(elem);
  }
  ...
  public Feed setItems(List<EventsItem> items) {
    this.items = items;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ITEMS:
      if (value == null) {
        ...
        setItems((List<EventsItem>)value);
      }
      break;
          ...
          if (field.type == org.apache.thrift.protocol.TType.LIST) {
            {
              ...
              this.items = new ArrayList<EventsItem>(_list0.size);
              for (int _i1 = 0; _i1 < _list0.size; ++_i1)
              {
                EventsItem _elem2; // required
                _elem2 = new EventsItem();
                _elem2.read(iprot);
  ...
  public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    ...
    if (this.items != null) {
      oprot.writeFieldBegin(ITEMS_FIELD_DESC);
      {
        ...
        for (EventsItem _iter3 : this.items)
        {
          _iter3.write(oprot);
        }
        oprot.writeListEnd();
