...
{  
    ...
    {
        if (localName.equalsIgnoreCase("channel") || qName.equalsIgnoreCase("channel"))
            this.rssFeed = new RssFeed();
        else if ((localName.equalsIgnoreCase("item") || qName.equalsIgnoreCase("item")) && (this.rssFeed != null))
        {
            this.item = new Item();
            this.rssFeed.addItem(this.item);
        }
        else if ((localName.equalsIgnoreCase("image") || qName.equalsIgnoreCase("image")) && (this.rssFeed != null))
            this.imgStatus = true;
    }
    ...
    public void endElement(String uri, String localName, String qName)
    {
        ...
        else if (localName.equalsIgnoreCase("image") || qName.equalsIgnoreCase("image"))
        ...
        else if ((localName.equalsIgnoreCase("url")|| qName.equalsIgnoreCase("url")) && this.imgStatus)
            this.rssFeed.imageUrl = this.text.toString().trim();
       
        else if (localName.equalsIgnoreCase("language") || qName.equalsIgnoreCase("language"))
            this.rssFeed.language = this.text.toString().trim();
       
        else if (localName.equalsIgnoreCase("generator") || qName.equalsIgnoreCase("generator"))
            this.rssFeed.generator = this.text.toString().trim();
       
        else if (localName.equalsIgnoreCase("copyright") || qName.equalsIgnoreCase("copyright"))
            this.rssFeed.copyright = this.text.toString().trim();
       
        else if ((localName.equalsIgnoreCase("pubDate")|| qName.equalsIgnoreCase("pubdate")) && (this.item != null))
            this.item.pubDate = this.text.toString().trim();
       
        else if ((localName.equalsIgnoreCase("category") || qName.equalsIgnoreCase("category")) && (this.item != null))
