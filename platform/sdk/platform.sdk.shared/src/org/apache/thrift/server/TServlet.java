...
public class TServlet extends HttpServlet {
	...
	public static Map<Object, Object> requestsMap = Collections.synchronizedMap(new IdentityHashMap<Object, Object>());
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			// processor.hello("client IP is " + request.getRemoteAddr());
			...
			processor.process(inProtocol, outProtocol, request);
			out.flush();
		} catch (TException te) {
