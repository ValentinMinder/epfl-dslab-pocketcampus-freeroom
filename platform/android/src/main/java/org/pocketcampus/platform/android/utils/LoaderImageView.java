...
public class LoaderImageView extends LinearLayout {
	 ...
	 * use the tag
	 * 'src="http://developer.android.com/images/dialog_buttons.png"' Replacing
	 * the url with your desired image Once you have instantiated the XML view
	 * you can call setImageDrawable(url) to change the image
	 * 
	 * @param context
	 * @param attrSet
	 */
