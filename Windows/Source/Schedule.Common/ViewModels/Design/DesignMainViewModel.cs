...
namespace PocketCampus.Schedule.ViewModels.Design
{
    public sealed class DesignMainViewModel
    {
                        ...
                        new StudyDay
                        {
                            ...
                            Periods = new[]
                            {
                                new Period
                                {
                                    ...
                                    Start = new DateTime( 2013, 5, 6, 8, 0, 0 ),
                                ...
                                {
                                    CourseName = "Analyse II",
                                    Start = new DateTime( 2013, 5, 6, 13, 0, 0 ),
                                ...
                                new Period
                                {
                                    ...
                                    Start = new DateTime( 2013, 5, 6, 14, 0, 0 ),
                                ...
                                new Period
                                {
                                    ...
                                    Start = new DateTime( 2013, 5, 6, 16, 0, 0 ),
                        ...
                        new StudyDay
                        {
                            ...
                            Periods = new[]
                            {
                                ...
                                new Period
                                {
                                    ...
                                    Start = new DateTime( 2013, 5, 7, 8, 0, 0 ),
                                ...
                                {
                                    CourseName = "Projet de technologie de l'information",
                                    Start = new DateTime( 2013, 5, 7, 9, 0, 0 ),
                                ...
                                {
                                    CourseName = "Projet de technologie de l'information",
                                    Start = new DateTime( 2013, 5, 7, 12, 0, 0 ),
                                ...
                                {
                                    CourseName = "Projet de technologie de l'information",
                                    Start = new DateTime( 2013, 5, 7, 14, 0, 0 ),
                                ...
                                {
                                    CourseName = "Discrete structures",
                                    Start = new DateTime( 2013, 5, 7, 15, 0, 0 ),
                                ...
                                new Period
                                {
                                    ...
                                    Start = new DateTime( 2013, 5, 7, 16, 0, 0 ),
                    ...
                    (
                        new StudyDay
                        {
                            ...
                            Periods = new[]
                            {
                                ...
                                {
                                    CourseName = "Analyse II",
                                    Start = new DateTime( 2013, 5, 8, 10, 0, 0 ),
                                ...
                                {
                                    CourseName = "Discrete structures",
                                    Start = new DateTime( 2013, 5, 8, 13, 0, 0 ),
                                ...
                                {
                                    CourseName = "Discrete structures",
                                    Start = new DateTime( 2013, 5, 8, 15, 0, 0 ),
                    ...
                    (
                        new StudyDay
                        {
                            ...
                            Periods = new[]
                            {
                                ...
                                {
                                    CourseName = "Analyse II",
                                    Start = new DateTime( 2013, 5, 9, 8, 0, 0 ),
                                ...
                                new Period
                                {
                                    ...
                                    Start = new DateTime( 2013, 5, 9, 14, 0, 0 ),
                                ...
                                {
                                    CourseName = "Systèmes logiques II",
                                    Start = new DateTime( 2013, 5, 9, 16, 0, 0 ),
                    ...
                    (
                        new StudyDay
                        {
                            ...
                            Periods = new[]
                            {
                                ...
                                {
                                    CourseName = "Théorie et pratique de la programmation",
                                    Start = new DateTime( 2013, 5, 10, 11, 0, 0 ),
                                ...
                                {
                                    CourseName = "Théorie et pratique de la programmation",
                                    Start = new DateTime( 2013, 5, 10, 13, 0, 0 ),
        ...
        public DayInfo CurrentDay { get { return Days[0]; } }
