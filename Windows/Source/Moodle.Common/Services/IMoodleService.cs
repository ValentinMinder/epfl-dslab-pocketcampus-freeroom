...
namespace PocketCampus.Moodle.Services
{
    ...
    public interface IMoodleService
    {
        ...
        Task<CourseListResponse> GetCoursesAsync( [ThriftParameter( 1, "dummy" )] string ignore );
        ...
        Task<CourseSectionListResponse> GetCourseSectionsAsync( [ThriftParameter( 1, "courseId" )] string courseId );
    }
}