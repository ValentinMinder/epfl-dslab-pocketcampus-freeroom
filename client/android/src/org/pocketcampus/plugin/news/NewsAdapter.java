...
public class NewsAdapter extends ArrayAdapter<NewsItem> {
	...
	public void setDebugData() {
		...
		this.add(new NewsItem("Des anticancéreux pour combattre la malaria?", "Une nouvelle classe de médicaments utilisés dans le cadre de la chimiothérapie contre le cancer est également active contre le paludisme.", "http://actu.epfl.ch/news/des-anticancereux-pour-combattre-la-malaria", "2011-03-03", null));
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		Log.d(NewsAdapter.class.toString(), "Creating view for position " + position);
