...
public class SandwichListStore {
	...
	/* to use the method (get and set Sandwich) from the server */
//	private ServerAPI sApi;
	
	/* Constructor */
	public SandwichListStore() /*throws ServerException*/{
...
//		if(sApi == null) throw new IllegalArgumentException("serverAPI can not be null");
	...
	/* add the listSandwich to the server */
	private void addListSandwichToTheServer(Vector<Vector<Sandwich>> listToStor) /*throws ServerException*/{
		for(Vector<Sandwich> store: listToStor){
			for(Sandwich sandwich: store){
				System.out.println("add : " + sandwich.getRestaurant() + " " + sandwich.getName() + " !!!" );
//				sApi.setSandwichAvailability(sandwich, true);
			}
		}
	}
	
	/* take the collection sandwich from the server and sort (class) by restaurant */
	private Vector<Vector<Sandwich>> sortListSandwichByRestaurant() /*throws ServerException*/{
		
		/* my list of sandwich sort by Restaurant */
		Vector<Vector<Sandwich>> list = new Vector<Vector<Sandwich>>();
		/* List of Restaurant name */
		Vector<String> storeList = new Vector<String>();
		/* get collection Sandwich from the server */
//		Collection<Sandwich> sandwichListServer = sApi.getSandwiches();
		...
		Sandwich s3 = new Sandwich("Satellite", "Tomate Mozzarella", true, new Date());
		...
		for(Sandwich i: sandwichListServer){
			if(storeList.contains(i.getRestaurant())){
				...
				if(position < 0) throw new IllegalArgumentException("no element in the list !");
				else list.get(position).add(i);
			}
			else{
	...
	/* help the method sortListSandwichByRestaurant() to find the position of the restaurant */
	private int findPositionRestaurant(String name, Vector<Vector<Sandwich>> list){
		int sizeList = list.size();
		for(int i=0; i<sizeList; i++){
			if(name.equals(list.get(i).get(0).getRestaurant())) return i;
		}
		return -1;
	}
	
	/* create the list of sandwich in the EPFL (to do -> change modifiySandwichList_ to TRUE) */
	private void createListSandwich(){
		
		/* Cafeteria INM */
		Vector<Sandwich> CafeteriaINM = new Vector<Sandwich>();
		CafeteriaINM.add(new Sandwich("Cafeteria INM", "Poulet au Curry", true, new Date()));
		CafeteriaINM.add(new Sandwich("Cafeteria INM", "Thon", true, new Date()));
		CafeteriaINM.add(new Sandwich("Cafeteria INM", "Jambon", true, new Date()));
		CafeteriaINM.add(new Sandwich("Cafeteria INM", "Fromage", true, new Date()));
		CafeteriaINM.add(new Sandwich("Cafeteria INM", "Tomate Mozzarella", true, new Date()));
		CafeteriaINM.add(new Sandwich("Cafeteria INM", "Jambon Cru", true, new Date()));
		CafeteriaINM.add(new Sandwich("Cafeteria INM", "Salami", true, new Date()));
		CafeteriaINM.add(new Sandwich("Cafeteria INM", "Autres", true, new Date()));
		...
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Jambon", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Salami", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Jambon de dinde", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Gruyière", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Viande Séchée", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Jambon cru", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Roast-Beef", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Poulet Jijommaise", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Crevettes", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Saumon fumé", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Poulet au Curry", true, new Date()));
		CafeteriaSG.add(new Sandwich("Le Giacomettia", "Autres", true, new Date()));
		
		/* L'Esplanade */
		Vector<Sandwich> esplanade = new Vector<Sandwich>();
		esplanade.add(new Sandwich("L'Esplanade", "Thon", true, new Date()));
		esplanade.add(new Sandwich("L'Esplanade", "Poulet au Curry", true, new Date()));
		esplanade.add(new Sandwich("L'Esplanade", "Aubergine", true, new Date()));
		esplanade.add(new Sandwich("L'Esplanade", "Roast-Beef", true, new Date()));
		esplanade.add(new Sandwich("L'Esplanade", "Jambon Cru", true, new Date()));
		esplanade.add(new Sandwich("L'Esplanade", "Vuabde Séchée", true, new Date()));
		esplanade.add(new Sandwich("L'Esplanade", "Saumon Fumé", true, new Date()));
		...
		atlantide.add(new Sandwich("L'Atlantide", "Sandwich long", true, new Date()));
		atlantide.add(new Sandwich("L'Atlantide", "Sandwich au pavot", true, new Date()));
		atlantide.add(new Sandwich("L'Atlantide", "Sandwich intégral", true, new Date()));
		atlantide.add(new Sandwich("L'Atlantide", "Sandwich provençal", true, new Date()));
		atlantide.add(new Sandwich("L'Atlantide", "Parisette", true, new Date()));
		...
		atlantide.add(new Sandwich("L'Atlantide", "Mozzarella", true, new Date()));
		atlantide.add(new Sandwich("L'Atlantide", "Saumon Fumé", true, new Date()));
		atlantide.add(new Sandwich("L'Atlantide", "Viande Séchée", true, new Date()));
		atlantide.add(new Sandwich("L'Atlantide", "Jambon Cru", true, new Date()));
		atlantide.add(new Sandwich("L'Atlantide", "Roast-Beef", true, new Date()));
		...
		satellite.add(new Sandwich("Satellite", "Jambon fromage", true, new Date()));
		satellite.add(new Sandwich("Satellite", "Roast-Beef", true, new Date()));
		satellite.add(new Sandwich("Satellite", "Poulet au Curry", true, new Date()));
		satellite.add(new Sandwich("Satellite", "Jambon Cru", true, new Date()));
		satellite.add(new Sandwich("Satellite", "Tomate mozza", true, new Date()));
		satellite.add(new Sandwich("Satellite", "Salami", true, new Date()));
		satellite.add(new Sandwich("Satellite", "Parmesan", true, new Date()));
		satellite.add(new Sandwich("Satellite", "Aubergine grillé", true, new Date()));
		satellite.add(new Sandwich("Satellite", "Viande séchée", true, new Date()));
	...
	private Vector<Sandwich> defaultSandwichList(String name){
		...
		defaultSandwichList.add(new Sandwich(name, "Fromage", true, new Date()));
		defaultSandwichList.add(new Sandwich(name, "Tomate Mozzarella", true, new Date()));
		defaultSandwichList.add(new Sandwich(name, "Jambon Cru", true, new Date()));
