...
public class Search {
	...
	*/
	 ...
	 */
	public static Path searchPathBetween(MapElement startMapElement, MapElement endMapElement, boolean bike) {
		...
		*/
		...
		try {
			...
			if (jsonString == null) {
				...
				Log.d("Search", "jsonString is null in searchPathBetween-Method between VertexID:"+17435+" and "+ 6718);
				return null;
			}
