...
@interface MoodleController : PluginController<UISplitViewControllerDelegate, PluginControllerProtocol, AuthenticationCallbackDelegate, MoodleServiceDelegate>
