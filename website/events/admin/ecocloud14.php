...
$EVENT_TITLE = "EcoCloud 2014";

$SECTIONS = array();

$SECTIONS[] = array("POOL" => "23000010", "TYPE" => "schedule", "NAME" => "schedule");
$SECTIONS[] = array("POOL" => "23000070", "TYPE" => "posters", "NAME" => "posters");
$SECTIONS[] = array("POOL" => "23000071", "TYPE" => "participants", "NAME" => "participants");
$SECTIONS[] = array("POOL" => "23000080", "TYPE" => "labs", "NAME" => "labs");
$SECTIONS[] = array("POOL" => "23000081", "TYPE" => "affiliates", "NAME" => "affiliates");
$SECTIONS[] = array("POOL" => "23000090", "TYPE" => "venue", "NAME" => "venue");

$ID_MAP = array();

$ID_MAP["GOOGLE_SPREADSHEET"] = "1KEeefvGvknUhA5jerC96ifSukf-VEUWVndSVnLT4zMY";
$ID_MAP["23000010"] = "119560255";
$ID_MAP["23000070"] = "825413559";
$ID_MAP["23000071"] = "1842160259";
$ID_MAP["23000080"] = "1314805599";
$ID_MAP["23000081"] = "1173699225";
$ID_MAP["23000090"] = "210404313";
