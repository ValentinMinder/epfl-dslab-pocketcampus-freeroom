...
//      {
      ...
      echo "<h2>Uploaded to (copy the URL below to PictureURL_IF_NOT_FROM_EPFL column in spreadsheet)</h2> <p>https://pocketcampus.epfl.ch/events/openhouse2014/images/$new_file</p>";// . $_FILES["file"]["name"];
