...
<form action="?" method="post">
	...
	<div style='margin-top:50px;'>
		<b>EcoCloud event :: Poster QR code download page</b>
	</div>
...
?>
				...
				<tr>
					<td>QR code</td>
					<td style="text-align:center;"><iframe style="width:200px;height:200px;border:1px solid;" id="qr_image" ></iframe></td>
				</tr>
				<tr>
					<td>Link</td>
...
<p>For your poster, you must use <a href="poster.ai">this Adobe Illustrator EcoCloud poster template</a> or 
<a href="poster.png"> this PNG file that you can use as background (300 dpi)</a>.<br/> Both files show you where to place the QR code.<br/>Make sure that the QR code completely covers the red square!</p>
<script>
    function set_image(iid) {
        url = "http://chart.apis.google.com/chart?cht=qr&chs=200x200&chl=pocketcampus://events.plugin.pocketcampus.org/showEventPool?eventPoolId=15000004%26markFavorite=" + iid;
