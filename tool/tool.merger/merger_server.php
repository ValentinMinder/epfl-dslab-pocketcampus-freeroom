...
$plugins_to_merge = array("Camipro", "Moodle", "Authentication", "Food", "Transport", "News", "Satellite", "Map", "Bikes", "Directory", "PushNotif", "MyEdu", "Events", "QAforum");

$libs_to_export = array("backport-util-concurrent-3.1.jar", "bcprov-jdk15-146.jar", "commons-io-2.0.1.jar", "commons-lang-2.6.jar", "commons-lang3-3.0.1.jar", "commons-logging-1.1.1.jar", "gson-1.7.1.jar", "gcm-server.jar", "ical4j-1.0.4.jar", "javapns_2.2.jar",
		...
		"json_simple-1.1.jar", "jsoup-1.6.1.jar", "kxml2-2.3.0.jar", "libthrift-0.7.0-multiplex.jar", "log4j-1.2.16.jar", "mail.jar", "mysql-connector-java-5.1.15-bin.jar", "servlet-api-3.0.jar", "slf4j-api-1.6.2.jar", "slf4j-simple-1.6.2.jar", "unboundid-ldapsdk-se.jar");
